          ...
          <section>
            <ul className='m-2 flex flex-wrap gap-1'>
              {Array.from({ length: 4 }).map((i, index) => (
                <li className='w-[calc(100%-1px)] md:w-[calc(33%-1px)]' key={index}>
                    ...
                    <div className='flex flex-col mt-2 mb-8 w-full'>
                      <div className='flex items-center justify-between mr-4'>
                        <Typography className='w-30 lg:w-60 truncate font-normal normal-case'>
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores accusamus
                          inventore dolorem molestias sed autem voluptate, doloribus quibusdam optio
                          odit iusto nesciunt mollitia magnam nam delectus sunt, sequi in dolorum!
                        </Typography>
                      ...
                      <div>
                        <Typography className='font-normal normal-case'>Rs. 1800.00</Typography>
                      </div>
                      <div>
        ...
        <div className='w-full md:basis-[30%] flex flex-col pb-0 pl-6 pr-8 pt-4 h-full sticky top-[7rem]'>
          <div className='flex flex-col gap-2 w-full'>
            <div className='flex items-center justify-between'>
              <Typography className='text-sm font-normal normal-case'>Subtotal</Typography>
              <Typography className='text-sm font-normal normal-case'>Rs. 1800.00</Typography>
            </div>
            <div className='flex items-center justify-between'>
              <Typography className='text-sm font-normal normal-case'>Delivery</Typography>
              <Typography className='text-sm font-normal normal-case'>Free</Typography>
            </div>
            <div className='flex items-center justify-between'>
              ...
              <Typography className='text-sm tracking-wider'>Rs. {4 * 1800.0}</Typography>
            </div>
          ...
          <div className='mt-4'>
            <Accordion type='single' collapsible>
              <AccordionItem value='item-1'>
                <AccordionTrigger>Do you have a promotional code?</AccordionTrigger>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex items-center gap-2'>
                <Check strokeWidth={0.75} />
                <Typography className='font-normal normal-case'>Free returns in 30 days</Typography>
              </div>
            </div>
          </div>
        </div>
