      ...
      >
        <CarouselContent>
          {Array.from({ length: 100 }).map((_, index) => (
            <CarouselItem key={index} className='flex-none w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5'>
              <div className='p-0.5'>
                        ...
                        <div className='flex justify-between'>
                          <div className='ml-2 lg:ml-4  flex flex-col gap-2'>
                            ...
                            <Typography className='normal-case font-normal text-sm truncate w-25 lg:w-40'>
                              ...
                              excepturi rerum facilis nesciunt assumenda corrupti, veritatis
                              perferendis doloremque, soluta reprehenderit et, voluptates dolorum
                              est mollitia ipsa quibusdam! Dolore, hic. Quis?
                            </Typography>
