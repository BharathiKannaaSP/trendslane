        ...
        <Tabs defaultValue='description'>
          ...
          <TabsContent value='description' className='p-2 '>
            <Typography className='font-normal normal-case  break-words'>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem iusto, itaque
              ipsam magni recusandae quaerat optio unde pariatur aut aliquam numquam sequi nihil
              quas perspiciatis. Magni quaerat omnis optio sed!
            </Typography>
            <div className='mt-4'>
          ...
          <TabsContent value='delivery' className='pt-4 pl-3'>
            <div className='flex flex-col gap-6 mb-4'>
              ...
              <div className='flex items-center justify-between pl-0 pr-4'>
                <Typography className='normal-case font-normal'>Home delivery</Typography>
                <Typography className='normal-case font-normal'>0 to 8 working days</Typography>
            ...
            <div className='flex flex-col gap-6 mt-4 mb-4'>
              ...
              <Typography className='normal-case font-normal'>
                You have <b className='font-semibold'>30 days</b> (14 days for items from the
                CAPSULE collection) to return your order by any of the following methods:
              </Typography>
            ...
            <div className='flex flex-col gap-4 mt-4'>
              <Typography className='normal-case font-normal'>
                For reasons of hygiene, sealed products such as lingerie, underwear, swimwear
                products and earrings that do not have the label or protective seal attached cannot
                be returned.
              </Typography>
              <Typography className='normal-case font-normal'>
                Items containing flammable substances (such as perfumes, body mist, etc.) can only
                be returned with the hazardous goods label and in the original packaging.
              </Typography>
              <Typography className='normal-case font-normal'>
                See
                <Button variant='link' asChild className='p-0 font-semibold'>
                  <NavLink className='normal-case p-1' href='/help' label='Help' />
                </Button>
