    ...
    <div className='w-full p-10'>
      ...
      <div className='pt-8 lg:p-14 flex flex-col lg:flex-row gap-10'>
        <div className='flex flex-col gap-2 whitespace-nowrap'>
          <Typography className='text-6xl font-normal text-center'>{average} ★</Typography>
      ...
      {Array.from({ length: 5 }).map((card, index) => (
        <Card key={index} className='w-full max-w-full lg:max-w-1/2 mt-4 rounded-none'>
          <CardHeader>
            ...
            <CardAction>
              <Button variant='link' aria-label='Edit or delete this review'>
                <EllipsisVertical />
              </Button>
            </CardAction>
          </CardHeader>
            ...
            <div>
              ...
              <div className='mt-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between'>
                ...
                <div className='flex gap-4 items-center'>
                  <div className='flex gap-2 items-center'>
                    <Button aria-label='91 people found this review is helpful' variant='ghost'>
                      <ThumbsUp /> 91
                    </Button>{' '}
                  </div>
                  <div className='flex gap-2 items-center'>
                    <Button aria-label='30 people found this review is not-helpful' variant='ghost'>
                      <ThumbsDown /> 30
                    </Button>{' '}
                  </div>
                  <div className='flex gap-2 items-center'>
                    <Button aria-label='Report this review dropdown-collapsed' variant='ghost'>
                      <ChevronDown />
                    </Button>
                  </div>
                </div>
