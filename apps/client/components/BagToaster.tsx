        ...
        <div className="mt-4 flex items-end gap-2">
          ...
          <div className="flex flex-col gap-2">
            <Typography className="w-40 truncate font-normal normal-case">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni soluta sit accusamus
              debitis reprehenderit nisi atque optio dolorem, quod, asperiores recusandae itaque
              inventore adipisci. Consequatur fugit cumque numquam laborum consequuntur!
            </Typography>
            <Typography className="w-40 truncate font-normal normal-case">Rs. 4000.00</Typography>
            <Typography className="w-40 truncate font-normal normal-case">L Chocolate</Typography>
          </div>
        </div>
